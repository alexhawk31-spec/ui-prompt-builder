const ICON_PATHS = {
  palette: (
    <>
      ...
      <path d="M12 2C6.49 2 2 6.49 2 12s4.49 10 10 10c1.66 0 3-1.34 3-3 0-.79-.31-1.5-.81-2.03-.49-.52-.79-1.21-.79-2.02 0-1.66 1.34-3 3-3h3.03c3.32 0 6.02-2.69 6.02-6.01A9.99 9.99 0 0012 2z" />
    </>
  ),
  briefcase: (
    <>
  ...
  hammer: (
    <>
      ...
      <path d="M20.91 11.7l-1.25-1.25c-.6-.6-.93-1.4-.93-2.25V6.5a.5.5 0 01.5-.5c.92 0 1.79.37 2.44 1.02l1.12 1.12" />
      <path d="M13.04 2.82l1.13 1.12c.6.6.94 1.4.94 2.25V8" />
    </>
  ),
  users: (
    <>
